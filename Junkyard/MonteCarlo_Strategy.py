...
# Define the montecarlo function
...
# Attach montecarlo to Pandas Series
...
mc_results = data['Return'].montecarlo(sims=100, bust=-0.1, goal=0.1)

# Print results and plot
print("Simulation Statistics:", mc_results.stats)
mc_results.plot(title=f"Monte Carlo Simulation for {symbol}")
